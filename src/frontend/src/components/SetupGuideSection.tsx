...
import { ClipboardCopy, Download, Smartphone } from "lucide-react";
...
const steps: {
...
}[] = [
  {
    ...
    description:
      "Get the Unity mobile app from the iOS App Store or Google Play Store for your device.",
  },
  {
    id: "claim",
    step: 2,
    ...
    description:
      "Browse available lease codes on this website and copy one to your clipboard.",
  },
  {
    id: "enter",
    step: 3,
    ...
    description:
      "Open the Unity app, enter your lease code, and start earning with your mobile device.",
  },
];
