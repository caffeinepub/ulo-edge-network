...
const shorts = [
  {
    ...
    description:
      "A quick guide to getting started with the Unity Nodes app and the ULO Mobile Edge Network.",
  },
  {
    id: "short-2",
    videoId: "gdBxIyO-cIg",
    ...
    description:
      "Learn how to claim and activate your lease code inside the Unity Nodes app.",
  },
];
