      ...
      <div className="container px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-sm text-muted-foreground">
              Connecting Unity Node Operators with License Operators for
              seamless mobile earning opportunities on the decentralized
              network.
            </p>
          </div>
        ...
        <div className="border-t border-border/40 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          ...
          <p className="flex items-center gap-1">
            Built with{" "}
            <Heart className="h-4 w-4 text-red-500 fill-red-500 mx-0.5" /> using{" "}
            <a
