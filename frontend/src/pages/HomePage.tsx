        ...
        <div className="relative w-full" style={{ minHeight: '220px' }}>
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-6 sm:px-12 lg:px-20">
            <div className="max-w-xl">
              <h1 className="text-2xl sm:text-4xl lg:text-5xl font-bold tracking-tight leading-tight mb-3">
                ULO Mobile Edge Network
              </h1>
              <p className="text-sm sm:text-base lg:text-lg text-muted-foreground max-w-md">
                Lease codes by <strong>A304</strong> — turn your smartphone into a revenue-generating edge node.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 sm:py-10 bg-primary/5 border-b border-border/40">
        <div className="container px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 max-w-4xl mx-auto">
            <div>
              <h2 className="text-lg sm:text-xl font-semibold">Get the Unity Network App</h2>
              <p className="text-sm text-muted-foreground mt-1">Available on iOS and Android — free to download.</p>
            </div>
            <AppDownloadButtons />
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base">
                ...
                distributed between the UNO and ULO. Codes are single-use — copy and enter in the Unity app to
                activate.
              </p>
            </div>
            <LeaseListings />
