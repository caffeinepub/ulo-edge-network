...
export default function GlossarySection() {
  const terms = [
    {
      term: 'UNO',
      definition: 'Unity Node Operator - An individual or entity that operates Unity nodes and offers lease codes to ULOs.',
    },
    {
      term: 'ULO',
      definition:
  ...
  return (
    <section id="glossary" className="py-16 sm:py-20">
      <div className="container px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4">Glossary</h2>
